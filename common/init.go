...
func printHelp() {
	fmt.Println("ModelSet AI 平台 " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Usage: modelset [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
